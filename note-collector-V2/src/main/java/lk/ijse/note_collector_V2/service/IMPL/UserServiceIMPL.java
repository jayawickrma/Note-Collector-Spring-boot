...
import lk.ijse.note_collector_V2.Exeptions.UserNotFoutnExeptions;
...
public class UserServiceIMPL implements UserService {
    ...
    public UserDetailsService userdetailservice() {
        return username -> {
            try {
                return (UserDetails) userDAO.findByEmail(username).orElseThrow(()->new UserNotFoutnExeptions());
            } catch (UserNotFoutnExeptions e) {
